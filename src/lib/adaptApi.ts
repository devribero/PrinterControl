 ...
 */
import { api, type ApiAlert, type ApiPrinterWithStatus, type ApiTonerLevel } from "./api";
import type { Alert, MonthlyReport, Printer, PrinterStatus, TonerLevel } from "../types";
