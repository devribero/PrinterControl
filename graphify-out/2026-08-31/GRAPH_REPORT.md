...
## Summary
- 1592 nodes · 3233 edges · 98 communities (88 shown, 10 thin omitted)
...
Cohesion: 0.18
Nodes (13): adaptPrinter(), ApiMonthlyReport, formatLastSeen(), toStatus(), toToner(), VALID_COLORS, VALID_STATUS, ApiAlert (+5 more)
...
Cohesion: 0.10
Nodes (21): Logo Elgin é redesenho à mão (IA sem acesso a imagens coladas no chat, só uploads), AlertsDonutCard(), PagesConsumedCard(), ElginLogo(), ElginLogoProps, ACTIVE_NODES, features, LoginProps (+13 more)
...
### Community 32 - "printers.ts"
Cohesion: 0.15
Nodes (15): Levantamento_impressões (planilha original), ReportsPage(), DecommissionedList(), DecommissionedListProps, DepartmentBreakdown(), DepartmentBreakdownProps, MONTHS, MonthlyCounters() (+7 more)
...
### Community 37 - "cn"
Cohesion: 0.09
Nodes (30): AlertsPage(), TonerPage(), AlertsView(), PrinterDetailsModal(), PrinterDetailsModalProps, PrinterRanking(), PrinterRankingProps, RankedPrinter (+22 more)
...
Cohesion: 0.09
Nodes (26): AlertBanner(), AlertBannerProps, AlertsViewProps, AlertsDonutCardProps, BottomCharts(), BottomChartsProps, TotalPrintsCard(), DemoDataBadge() (+18 more)
...
Cohesion: 0.11
Nodes (29): public/data/monthly-report.json, public/data/printers.json, Arquivos de dados gerados são ignorados pelo git — gerar/apagar localmente nunca afeta o repositório, decommissionedPrinters, monthlyUsage, adaptAlert(), loadMonthlyReportFromApi(), BackendEnvironment (+21 more)

### Community 51 - "UsersView.tsx"
Cohesion: 0.11
Nodes (19): ComingSoon(), ComingSoonProps, RequireRole(), FORM_VAZIO, formatarData(), FormState, UsersView(), confirmarAtivacao() (+11 more)

### Community 52 - "useAppData"
Cohesion: 0.12
Nodes (22): DashboardPage(), PrintersPage(), AppShell(), AuthGate(), Login(), handleSubmit(), Modal(), ModalProps (+14 more)
...
Cohesion: 0.20
Nodes (19): salvarPerfil(), abrirEdicao(), api, clearToken(), isTokenPersistent(), setToken(), ApiUser, cacheAccount() (+11 more)

### Community 60 - "toast.tsx"
Cohesion: 0.07
Nodes (30): react, ibmPlexMono, metadata, publicSans, sourceSerif, Providers(), TEMAS, ESCALAS (+22 more)
...
## Knowledge Gaps
- **392 isolated node(s):** `$schema`, `typescript`, `oxc`, `react/rules-of-hooks`, `warn` (+387 more)
