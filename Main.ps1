...
$script:configJson = @'
{
    ...
    "ModoOffline": false,
    "WebhookUrl": "https://***HOST-REMOVIDO***.environment.api.powerplatform.com:443/powerautomate/automations/direct/cu/27/workflows/***REMOVIDO***/triggers/manual/paths/invoke?api-version=1&sp=%2Ftriggers%2Fmanual%2Frun&sv=1.0&sig=***REMOVIDO***",
    "DriverMap": [
